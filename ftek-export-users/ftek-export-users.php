...
function ftek_export_users() {
    ...
    function copyText(text) {
      ...
      document.body.removeChild(textArea);
        ...
        {   
            var html = '<div class="tablenav-pages" style="float:left">';
            html += '<span class="button email_copy_button" onclick="copyEmails()" style="margin-right: 0.5em;">Copy Email List</span>';
