...
function ftek_export_users() {
    ...
    <script type="text/javascript">
        ...
        {
            $('.tablenav.top .clear, .tablenav.bottom .clear').before('<form action="#" method="POST"><input type="hidden" id="ftek_export_csv" name="ftek_export_csv" value="1" /><input class="button button-primary user_export_button" style="margin-top:3px;" type="submit" value="<?php esc_attr_e('Export All as CSV', 'ftek');?>" /></form>');
        });
    </script>
    <?php
}
